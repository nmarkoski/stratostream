    ...
    return (
        <div className="w-full flex flex-col justify-center items-center p-6">
            ...
            <div className="w-full md:w-[40%] flex flex-col gap-8">
                ...
                <div className="w-full flex flex-row justify-between items-center">
                    <div className="flex flex-col">
                        <span className="text-lg font-semibold">Region preference</span>
                        <span className="text-sm font-light text-zinc-800 dark:text-zinc-300">Only affects the selection on the front page</span>
                    </div>
