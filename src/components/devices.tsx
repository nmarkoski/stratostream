...
export function DesktopInlineBlock({
    children,
    className,
}: React.HTMLProps<HTMLDivElement>) {
    return (
...
export function DesktopFlex({
    children,
    className,
}: React.HTMLProps<HTMLDivElement>) {
    return <div className={cn(className, "hidden md:flex")}>{children}</div>;
}
...
export function MobileInlineBlock({
    children,
    className,
}: React.HTMLProps<HTMLDivElement>) {
    return (
...
export function MobileFlex({
    ...
    return <div className={cn(className, "flex md:hidden")}>{children}</div>;
}
