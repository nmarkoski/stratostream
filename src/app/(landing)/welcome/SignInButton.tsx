...
function SignInButton({ formAction, className }: ButtonProps) {
    ...
    return (
        <Button
            className={cn(
                className,
                "w-full bg-green-500 hover:bg-green-600 dark:bg-green-700 hover:dark:bg-green-600/90 text-zinc-50 dark:text-zinc-50",
            )}
        ...
        >
            {isPending ? (
                <LoaderCircle className="mr-2 mb-0.5 h-4 w-4 animate-spin" />
            ) : (
